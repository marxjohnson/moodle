...
class visibility {
    ...
    /**
     * @var int All users can see this group and its members.
     */
    public const ALL = 0;

    /**
     * @var int Members of this group can see this group and other members.
     */
    public const MEMBERS = 1;

    /**
     * @var int Members of this group can see the group and their own membership, but not each other's membership
     */
    public const OWN = 2;

    /**
     * @var int No-one can see this group or its members. Members of the group will not know they are in the group.
     */
    public const NONE = 3;
