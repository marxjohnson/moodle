...
class group_form extends moodleform {
    ...
    function definition () {
        ...
        $visibilityoptions = [
            visibility::ALL => get_string('visibilityall', 'group'),
            visibility::MEMBERS => get_string('visibilitymembers', 'group'),
            visibility::OWN => get_string('visibilityown', 'group'),
            visibility::NONE => get_string('visibilitynone', 'group')
        ];
        ...
        $mform->disabledIf('participation', 'visibility', 'in', [visibility::OWN, visibility::NONE]);
        ...
        if (\core_message\api::can_create_group_conversation($USER->id, $coursecontext)) {
            ...
            $mform->disabledIf('enablemessaging', 'visibility', 'in', [visibility::OWN, visibility::NONE]);
        }
