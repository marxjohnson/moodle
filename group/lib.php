...
function groups_create_group($data, $editform = false, $editoroptions = false) {
    ...
    $data->visibility ??= \core_group\visibility::ALL;

    if (!in_array($data->visibility, [\core_group\visibility::ALL, \core_group\visibility::MEMBERS])) {
...
function groups_update_group($data, $editform = false, $editoroptions = false) {
    ...
    if (isset($data->visibility) && !in_array($data->visibility, [\core_group\visibility::ALL, \core_group\visibility::MEMBERS])) {
        $data->participation = false;
        $data->enablemessaging = false;
    }
