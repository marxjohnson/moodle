...
class grouplib_test extends \advanced_testcase {
    ...
    protected function create_groups_with_visibilty(): array {
        ...
        // Create groups.
        $groups = [
            'all' => $generator->create_group(['courseid' => $course->id, 'visibility' => visibility::ALL]),
            'members' => $generator->create_group(['courseid' => $course->id, 'visibility' => visibility::MEMBERS]),
            'own' => $generator->create_group(['courseid' => $course->id, 'visibility' => visibility::OWN]),
            'none' => $generator->create_group(['courseid' => $course->id, 'visibility' => visibility::NONE]),
        ];
    ...
    public function test_groups_get_activity_allowed_groups(): void {
        ...
        // Create groups.
        $groups = [
            'all-p' => $generator->create_group(['courseid' => $course->id, 'visibility' => visibility::ALL]),
            'members-p' => $generator->create_group(['courseid' => $course->id, 'visibility' => visibility::MEMBERS]),
