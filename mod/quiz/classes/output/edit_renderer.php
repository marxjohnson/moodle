...
class edit_renderer extends \plugin_renderer_base {
     ...
     * @return string HTML to output.
     */
    public function question_preview_icon($quiz, $questiondata, $label = null, $variant = null, $version = null) {
        ...
        $url = quiz_question_preview_url($quiz, $question, $variant, $version);
