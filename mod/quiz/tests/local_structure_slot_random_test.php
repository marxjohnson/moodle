...
class local_structure_slot_random_test extends \random_question_filter_test_base {
    ...
    public function test_constructor() {
        ...
        $filtercondition->filters = $this->create_filters([$category->id], true);
    ...
    public function test_insert() {
        ...
        // Set the filter conditions.
        $filtercondition = new \stdClass();
        $filtercondition->filters = $this->create_filters([$category->id], true, [$footag->id, $bartag->id]);
        ...
        $this->assertTrue($filters['category']['filteroptions']['includesubcategories']);
