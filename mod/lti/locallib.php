...
function lti_get_launch_data($instance, $nonce = '') {
    ...
    $allparams = lti_build_request($instance, $typeconfig, $course, $typeid, $islti2, $rolevocab);
    if ($islti2) {
 ...
 */
function lti_build_request($instance, $typeconfig, $course, $typeid = null, $islti2 = false, $rolevocab = helper::ROLE_VOCAB_URI) {
    global $USER, $CFG;
