...
$string['lti:manage'] = 'View other users\' updates.';
$string['lti:admin'] = 'Be an administrator when the tool is launched';
$string['lti:contentdeveloper'] = 'Be a content developer when the tool is launched';
$string['lti:instructor'] = 'Be an instructor when the tool is launched';
$string['lti:learner'] = 'Be a learner when the tool is launched, in addition to other roles.';
$string['lti:manager'] = 'Be a manager when the tool is launched';
$string['lti:member'] = 'Be a member when the tool is launched';
$string['lti:mentor'] = 'Be a mentor when the tool is launched';
$string['lti:teachingassistant'] = 'Be a teaching assistant when the tool is launched';
