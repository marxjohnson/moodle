...
Feature: Submission types
  ...
  Scenario: Neither submission type explicitly required
    ...
    When I set the field "Title" to "Test submission"
    And I press "Save changes"
    Then I should see "You need to add a file or enter some text." in the "#id_error_attachment_filemanager" "css_element"
    And I should see "You need to enter some text or add a file." in the "#id_error_content_editor" "css_element"
    When I set the following fields to these values:
      | Submission content | Lorem ipsum dolor                          |
    And I press "Save changes"
    Then I should not see "You need to add a file or enter some text."
