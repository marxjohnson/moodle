...
Feature: Reset course
  ...
  Scenario: Reset large courses asynchronously
    ...
    And I click on "Reset course" "button" in the "Reset course?" "dialogue"
    And I should see "Resetting course C1 has timed out and been cancelled"
    ...
    And I should not see "This feature allows you to clear all user data and reset the course to its original state"
    And I should see "This course is being reset. You do not need to stay on this page."
    # Check that the course is hidden to students.
    And I am on the "Course 1" course page logged in as "student1"
    And I should see "This course is being reset."
    And I should not see "You do not need to stay on this page."
    And I should not see "Test assignment name"
    # Check that the teacher cannot access other parts of the course.
    ...
    # Check the course is visible to students again.
    And the following "course enrolments" exist:
      | user     | course | role           |
      | student1 | C1     | student        |
    And I am on the "Course 1" course page logged in as "student1"
