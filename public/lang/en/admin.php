...
$string['configenableasyncresets'] = 'Resetting courses with lots of contents or enrolments through the front end may be slow or time out. Enable this setting to offload course resets to asynchronous ad-hoc tasks.';
