...
$string['configasyncgrading'] = 'Enable asynchronous attempt grading';
$string['configasyncgrading_desc'] = 'When a student submits a quiz, their answers will be saved immediately, and any automatic grading will be performed by a background task. This improves frontend responsiveness, especially for large quizzes. This may cause the attempt state to display as "Finished" before grading is complete in the Moodle app.';
...
$string['expermimentalsettings'] = 'Experimental settings';
$string['expermimentalsettings_desc'] = 'These are experimental settings that control the system-wide behaviour of the Quiz activity.';
...
$string['lockgradesubmission'] = 'Awaiting lock';
$string['lockgradesubmissionfailed'] = 'Could not get lock on Quiz ID {$a->quizid}, user ID {$a->userid} after {$a->timeout} seconds.';
...
$string['reviewsubmitted'] = 'This attempt has been submitted. This page will refresh when your grades and feedback are available.';
