 ...
 */
final class update_category_order_test extends manage_category_test_base {
    /**
    ...
    private function get_current_order(array $categoryids): string {
        global $DB;
        [$wheresql, $params] = $DB->get_in_or_equal($categoryids);
    ...
    /**
     * Tests moving one category before another.
     *
     * @covers ::execute
     */
    public function test_update_category_order_before(): void {
        global $DB;
        $this->setAdminUser();
        $this->resetAfterTest();
        ...
        update_category_order::execute($qcat2->id, $qcat4->id);
    ...
    /**
     * Tests moving one category after another.
     *
     * @covers ::execute
     */
    public function test_update_category_order_after(): void {
        global $DB;
        $this->setAdminUser();
        $this->resetAfterTest();
        ...
        // Move question category 2 to after question category 3.
        update_category_order::execute($qcat2->id, $qcat3->id, false);
