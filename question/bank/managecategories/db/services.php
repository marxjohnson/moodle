...
$functions = [
    ...
    'qbank_managecategories_move_category_to_new_parent' => [
        'classname'    => 'qbank_managecategories\external\move_category_to_new_parent',
        'description'  => 'Move a question category under a new parent category',
        'type'         => 'write',
        'capabilities' => 'moodle/question:managecategory',
        'ajax'         => true,
    ],
