...
Feature: Time modified filter condition
  ...
  Scenario: Filter by questions modified before time
    ...
    And the field "Time modified 2" matches value "## now ##%FT%R##"
    And I set the field "Time modified 2" to "2024-01-10T10:59"
  ...
  Scenario: Filter by questions modified after time
    ...
    And the field "Time modified 1" matches value "## midnight 1 week ago ##%FT%R##"
    And I set the field "Time modified 1" to "2024-01-10T10:59"
    And I press "Apply filters"
  ...
  Scenario: Filter by questions modified between times
    ...
    And I set the field "Time modified 1" to "2024-01-10T10:59"
    And I set the field "Time modified 2" to "2024-01-10T11:01"
    And I press "Apply filters"
    Then I should not see "First question"
    And I should see "Second question"
    And I should not see "Third question"
  ...
  Scenario: Apply filter between invalid times
    ...
    And I set the field "Time modified 2" to "2024-01-10T11:01"
    And I press "Apply filters"
    And I set the field "Time modified 1" to "2024-01-10T11:01"
    And I set the field "Time modified 2" to "2024-01-10T10:59"
    And I press "Apply filters"
    Then I should see "Invalid datetime filter. \"After\" value 2024-01-10 11:01 was later than \"before\" value 2024-01-10 10:59."
    # Invalid values should not be set in the URL.
    When I reload the page
    Then the field "Time modified 1" matches value "2024-01-10T10:59"
    And the field "Time modified 2" matches value "2024-01-10T11:01"
