...
class data_mapper_base {
     ...
     *
     * This function returns a multi-dimentional array of itemname => [key => value] pairs, keyed by question id.
     ...
     * @return array [$questionid][$itemname][$key => $value] pairs of data.
     */
     ...
     * @param array $data Data to be imported as [$key => $value]. This will match the structure output by {@see get_question_data}.
