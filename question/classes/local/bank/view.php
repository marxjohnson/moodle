...
use core_question\output\qbank_filter;
...
class view {
    ...
    public function __construct($contexts, $pageurl, $course, $cm = null, $params = [], $extraparams = []) {
        ...
        if (!isset($params['filters']) && isset($params['cat'])) {
            ...
            $params['filterverb'] = condition::JOINTYPE_ALL;
        }
    ...
    public function wanted_filters(): void {
        ...
        $filter = new qbank_filter($catcontext, 'qbank-table', $this->searchconditions, $additionalparams,
                $this->component, $this->callback, static::class, $this->cm?->id, $this->pagevars, $this->extraparams);
