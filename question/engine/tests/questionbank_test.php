...
final class questionbank_test extends \advanced_testcase {
    ...
    public function test_load_many_for_cache_with_plugindata(): void {
        ...
        $this->assertEquals(['yesno' => ['value' => 0, 'valueformat' => FORMAT_MOODLE]], $qs[$q1->id]->qbank['customfields']);
        $this->assertEquals(['yesno' => ['value' => 1, 'valueformat' => FORMAT_MOODLE]], $qs[$q2->id]->qbank['customfields']);
        \qbank_customfields\customfield\question_handler::reset_caches();
    }
